...
- Comparar screenshot del sitio implementado vs screenshot del diseño en Stitch
- Verificar que tokens.css coincide con variables de Stitch (`mcp__pencil__get_variables`)
- Colores, tipografía y espaciado deben ser pixel-perfect respecto al diseño
